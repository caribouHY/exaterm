...
| `terminal_mode`            | string or null | Initial terminal mode for the profile. Supported values are `"general"`, `"cisco_ios"`, `"arista_eos"`, `"vyos"`, and `"fujitsu_sir"`. Missing values default to `"general"`. |
