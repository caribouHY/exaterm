...
| `terminal_mode`            | string or null | Initial terminal mode for the profile. Supported values are `"general"`, `"cisco_ios"`, `"arista_eos"`, `"vyos"`, `"fujitsu_sir"`, and `"allied_telesis_awplus"`. Missing values default to `"general"`. |
