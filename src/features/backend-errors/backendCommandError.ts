...
const errorKeys: Record<string, string> = {
  ...
  "serial.connect_cancelled": "backend_errors.serial_connect_cancelled",
  "serial.connect_request_id_required": "backend_errors.serial_connect_request_id_required",
  "terminal.send_failed": "backend_errors.terminal_send_failed",
  "telnet.connect_failed": "backend_errors.telnet_connect_failed",
  "telnet.connect_cancelled": "backend_errors.telnet_connect_cancelled",
  "telnet.connect_request_id_required": "backend_errors.telnet_connect_request_id_required",
  ...
  "config.saved_connection_duplicate": "backend_errors.config_saved_connection_duplicate",
  "config.saved_connection_not_found": "backend_errors.config_saved_connection_not_found",
  "config.saved_connection_name_required": "backend_errors.config_saved_connection_name_required",
