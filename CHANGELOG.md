...
- Fixed newly connected terminal tabs so they open at the right end of the tab bar, receive focus when Settings or Logs is active, and are not rolled back by stale workspace updates.
